...
public class HelloController {
    ...
    private void saveAsTxtFile(File file) {
        ...
        for (ObservableCountry c : countries) {
    ...
    @FXML
    protected void onHyperlinkClick() {
        System.out.println("onHyperlinkButtonClick");
        /*
        HostServicesDelegate hostServices = HostServicesDelegate.getInstance(HelloApplication.getApplicationInstance());
        hostServices.showDocument("https://www.scrapethissite.com/pages/simple/");
        */
        try {
            Desktop.getDesktop().browse(new URL("https://www.scrapethissite.com/pages/simple/").toURI());
        } catch (IOException e) {
            throw new RuntimeException(e);
